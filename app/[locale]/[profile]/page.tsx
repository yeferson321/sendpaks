 ...
 */}
            <div className="mx-auto max-w-[80rem] py-2.5 px-2 sm:px-5 md:px-10 lg:px-2.5 grid-columns gap-2.5">

                <div className="sticky top-0">
                    <Sidebar />
                </div>

                <div className="overflow-y-auto lg:min-w-[38rem] lg:max-w-[40rem]">

                    <div className="rounded-lg px-5 border dark:border-none dark:bg-background-base">
