...
export default function Header() {
    ...
    return (
        <>
            <nav className="xs:hidden shadow-lg bg-white dark:bg-elevated-base">

                <div className="flex flex-nowrap items-center justify-between p-3 rounded-xl">
                    ...
                    <div className="flex space-x-3">
                        ...
                        <button type="button" className="flex items-center p-1 rounded-full hover:bg-blue-50 dark:hover:bg-blue-500/5 group">
                        ...
                        <button type="button" onClick={() => setIsOpen(!isOpen)} className="flex items-center p-1 rounded-full hover:bg-blue-50 dark:hover:bg-blue-500/5 group" aria-expanded="false">
