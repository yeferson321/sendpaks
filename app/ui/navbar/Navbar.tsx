        ...
        <div className="flex flex-nowrap items-center justify-between p-3">
          ...
          <div className="flex space-x-3">
            ...
            <button type="button" className="p-1 rounded-full hover:bg-blue-50 dark:hover:bg-blue-500/5 group">
              ...
              <IconUser className="flex-shrink-0 w-7 h-7 stroke-neutral-500 dark:stroke-neutral-300 group-hover:stroke-custom-blue" />

            </button>

            <button type="button" onClick={() => setIsOpen(true)} className="p-1 rounded-full hover:bg-blue-50 dark:hover:bg-blue-500/5 group" aria-expanded="false">

              <span className="sr-only">Open main menu</span>

              <IconEllipsis className="flex-shrink-0 w-7 h-7 stroke-neutral-500 dark:stroke-neutral-300 group-hover:stroke-custom-blue" />
