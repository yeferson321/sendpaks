                ...
                <div className="">
                    ...
                    <div className="flex flex-col px-4 lg:px-5">
                        ...
                        <div className="relative -mt-12">
                            <Image src={userData.profilePictureUrl} onClick={() => openModal(userData.profilePictureUrl)} alt="Profile Picture" width={96} height={96} priority={true} className="rounded-full border-2 border-white dark:border-gray-950 flex-none" />
                        ...
                        */}
                        <div className="flex justify-between">
                            ...
                            <div className="flex items-end">
                                <button type="button" className="text-white bg-purple-700 hover:bg-purple-800 focus:outline-none ring-0 font-medium rounded-full text-sm px-5 py-2  text-center dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Suscribirse</button>
                            </div>
