...
export default function Multimedia({ multimedia }: MultimediaProps) {
    ...
    return (
        <div className="relative w-full mt-2">
            ...
            <div className="absolute z-30 flex -translate-x-1/2 top-4 left-1/2 space-x-4 rtl:space-x-reverse">
            ...
            {multimedia.length !== 1 && (
                <button onClick={() => changeSlide(-1)} type="button" className="absolute start-2 top-[45%] z-30 p-2 rounded-full hover:bg-black/10 cursor-pointer group focus:outline-none" data-carousel-prev>
            ...
            {multimedia.length !== 1 && (
                <button type="button" onClick={() => changeSlide(1)} className="absolute top-[45%] end-2 z-30 p-2 rounded-full hover:bg-black/10 cursor-pointer group focus:outline-none" data-carousel-next>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-4 h-4 stroke-white">
